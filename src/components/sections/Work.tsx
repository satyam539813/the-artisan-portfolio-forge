        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="grid md:grid-cols-5 gap-4 max-w-6xl mx-auto">
            {workProjects.map((project, index) => (
              ...
              >
                <div 
                  className="w-full h-20 rounded-lg mb-3 bg-cover bg-center relative overflow-hidden"
                  style={{ backgroundImage: `url(${project.imageUrl})` }}
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-transparent via-transparent to-white/20 backdrop-blur-sm" />
                </div>
